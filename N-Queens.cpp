...
class Solution {
    ...
    bool isPossible(vector<string>& partialAns, int row, int col, int n) {
        ...
        //if queen is present in the same row

        //NOT Possible because of function call



        //if queen is present in the same column
        ...
        //if queen is present in the 45 diagonal
        ...
        //if queen is present in the 135 diagonal
